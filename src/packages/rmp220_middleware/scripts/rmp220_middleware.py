...
from segway_msgs.srv import ros_set_chassis_enable_cmdRequest as chassis_enable_cmdRequest
...
class StateMachineNode:
    def __init__(self):
        ...
        self.chassis_enable_client = rospy.ServiceProxy('set_chassis_enable', chassis_enable_cmdRequest)
